...
So this is totally fucked because FSLE and SLA don't have crs given with their 
nc files from AVISO. Killing me. I also can't find it in their metadata on their 
webpage. I can get the same SLA from CMEMS and it has a crs but not FSLE. 
...
Downlaoding and saving CHL data globcolor
```{r, eval = FALSE}
